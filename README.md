...
| [Circuit V1.9](docs/Circuit_Enceinte_BT_Vintage_V1_9.md) | Main build guide with BOM and wiring |
| [Breakout Box V1.5](docs/Breakout_Box_Enceinte_BT_V1_5.md) | Test jig — Protected sense lines (fire-safe) |

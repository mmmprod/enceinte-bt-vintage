...
|----------|---------|-------------|
| [Circuit](Circuit_Enceinte_BT_Vintage_V1_6.md) | V1.6 | Complete build guide — BOM, wiring, step-by-step |
| [Breakout Box](Breakout_Box_Enceinte_BT_V1_2.md) | V1.2 | Test jig for debugging — 6 test points |
